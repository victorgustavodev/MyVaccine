<nav class="px-[6%] h-[8%] flex justify-between items-center navbar text-[#100E3D] bg-white shadow-md">
    ...
    <div class="flex gap-[64px] text-[16px]">
        <ul class="flex gap-6 justify-center items-center">
            <li>
            <li>
                <img src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcSOciWshHkTzFKgiKMJHUOW3OSQQ8Dv1A8ZWKkYZ2nKPgMmy7MOETlpjOp62raFIl-IOt0&usqp=CAU" class="w-10 p-1 2xl:p-[0px]  rounded-full" alt="">
            </li>
            </li>
