  ...
  <body class="overflow-x-hidden">
    ...
    <div class="w-full flex">
      ...
      <section class="flex justify-center items-center w-full lg:w-[60vw] h-[92vh]">
        <form
          action=""
          class="flex flex-col gap-6 px-6 lg:px-[32px] w-full lg:w-4/6 justify-center"
        >
          ...
          <div class="flex flex-col sm:flex-row gap-3 w-full text-xs md:text-base text-center sm:text-start">
            ...
            />
            <a href="login.php" class="bg-[#000A2E] text-white font-semibold py-4 px-10 rounded-lg hover:bg-[#1A2C6F]">
              Voltar ao login
            </a>
          </div>
        </form>
